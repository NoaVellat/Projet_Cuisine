    ...
    timeline: [
      {
        ...
        sub: 'Formation développeur web en alternance · Lyon',
        detail: 'HTML/CSS, JS, PHP/Laravel, Java/Spring Boot, Docker, CI/CD, AWS, MERN — diplôme en 2027',
      },
      {
        year: '2024–25',
        title: 'Chef de partie',
        sub: 'Les Cinq Mains — restaurant gastronomique · Lyon',
        detail: "Responsable d'un poste en cuisine : envois du chaud, pâtisserie, gestion d'équipe",
      },
      {
        year: '2023–24',
        title: 'Demi-chef de partie',
        sub: 'Le Théodore — brasserie gastronomique · Lyon 6e',
        detail: 'Cuisine aux côtés du Chef Pâtissier, encadrement des commis',
      },
      {
        year: '2020',
        title: 'Bac Pro TISSEC',
        sub: 'Institut des Ressources Industrielles · Lyon',
        detail: 'Technicien en Installation des Systèmes Énergétiques et Climatiques — chauffage, climatisation, sanitaire',
      },
      {
        year: '2019',
        title: 'Bac ES',
        sub: 'Lycée Colbert · Lyon',
        detail: 'Baccalauréat économique et social',
      },
    ],
  },
